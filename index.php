...
<html>
	...
	<head>
		...
		window.onload=function() {
			...
			/* REMOVE THIS AFTER
			var t1 = new Date();
			var t2 = new Date("2 Feb, 2014 19:00:00");
			if(t1>t2) {
				t2 = new Date("2 Feb, 2015 19:00:00");
			}
			...
			//LOL WORKING UNDER THE ASSUMPTION NO ONE WILL BE WAITING FOR MORE THAN LIKE 5 HOURS XD
			/* REMOVE THIS
...
<table style="background-color:#fff; border-collapse:collapse;" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td class="menu_button_box"><a class="menu_button_link" href="index.php" style="font-weight:bold;">HOME</a>
...
-->
	...
	<div style="text-align:center;">
		<span style="position:relative;">
			...
			<span style="background-color:#53b5b4; padding:15px; font-family:Raleway; color:#FFF;">
			This website is still under development &mdash; check in on us later!</b></u>
			</span>
			<div style="background-image:url(img/ribbon_tail.png); background-repeat:repeat-x; height:10px;"></div>
		</span>
	</div>
	<div style="font-family:Blanch; line-height:80%; color:#FFF; font-size:70px; margin:0 10px 0 10px; margin-top:50px; position:relative;"><!-- to be replaced with a jQuery automated solution -->
