...
<body>
	...
	<div style="line-height:80%; padding:4%; position:relative">
		...
		<div style="padding:0 10px 0 10px; padding-top:5vw; font-size:3vw; text-align:right"> The Conference Starts In: <div id="timeLeft" style="padding-top:3vw;">00 Days, 00 Hours, 00 Minutes, and 00 Seconds</div></div>
