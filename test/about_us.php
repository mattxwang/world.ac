	...
	<div id="carousel-web" class="carousel slide" data-ride="carousel" data-interval="8321">
		<div class="carousel-inner" role="listbox">
			<div class="item active bg-web">
				<div class = "row" style = "padding:5%;">
					<div class = "col-md-4" style = "text-align:right;">
						<img src = "img/bio/headshots/matt.png" style = "height:60%;"></img>
					</div>
					<div class = "col-md-8" style = "text-align:left;">
						<p>
						<h2><b>Matthew Wang</h2>
						</b>
			...
			<div class="item bg-web">
				<div class = "row" style = "padding:5%;">
					...
					<div class = "col-md-8" style = "text-align:left;">
						<p>
						<h2><b><a href = "http://jack.antinode.ca">Jack Sarick</a></h2>
						</b>
						<h3>Web Design</h3>
