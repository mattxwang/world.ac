...
<div class = "col-md-8"> 
	...
	<div id = "gen_date">
		<h3>2016 dates</h3></br>
		<p> We haven't quite decided the exact date of WAC. More information will be known as registration packages get sent out. </p></br>
	</div>
	<div id = "gen_days">
		<h3>Do students attend both days?</h3></br>
	...
	<div id = "how_to_reg">
		<h3>How can I register my school?</h3></br>
	...
	<div id = "theday">
		<h3>What can I expect on the day of WAC?</h3></br>
